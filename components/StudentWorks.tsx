...
const galleryItems = [
  ...
  { image: "/works/Radhe.png",     text: "RADHE SHYAM POSTER"     },
  { image: "/works/leo.jpg",      text: "LEO  POSTER"   },
  { image: "/works/salaar.png",    text: "SALAAR  POSTER"   },
  { image: "/works/fauji.png",     text: "FAUJI  POSTER"   },
  { image: "/works/eternal.png",   text: "BAHUBALI ETERNAL WARS POSTER"   },
];
      ...
      <section className="w-full py-24 flex flex-col items-center gap-12">
        ...
        <div className="w-full" style={{ height: "600px" }}>
          <CircularGallery
            ...
            textColor="#1A1A1A"
            borderRadius={0.05}
            font="bold 28px 'Bebas Neue', Impact, sans-serif"
            scrollSpeed={2}
            scrollEase={0.05}
          />
        </div>
